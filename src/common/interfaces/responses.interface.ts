...
export function toParcelListItem(parcel: any): any {
  ...
  return {
    ...
    cod_status: parcel.cod_status ?? null,
    ...
    rider_action_status: parcel.rider_action_status ?? null,
    rider_action_rider_id: parcel.rider_action_rider_id ?? null,
    hub_confirmation_status: parcel.hub_confirmation_status ?? null,
    rider_action_at: parcel.rider_action_at ?? null,
    hub_confirmed_at: parcel.hub_confirmed_at ?? null,
    completed_at: parcel.completed_at ?? null,
    is_delivery_rescheduled:
      parcel.rider_action_status === ParcelStatus.DELIVERY_RESCHEDULED,
